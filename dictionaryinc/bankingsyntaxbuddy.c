...
struct node* createdictionary(struct node* node)
{
  ...
  char line[250];
  FILE * fp = NULL; 
  const char *filename = "bankingsyntaxbuddy.txt";
  fp = fopen(filename,"r");
  if (fp == NULL)
    {
...
int main()
{
  ...
  printf("\n");
  printf( BOLD GREEN "                                                       WELCOME TO THE BANKING SYSTEM BUDDY\n" RESET);
  printf(GREEN "                                        _______________________________________________________\n" RESET);
  while(1)
    {
      printf("\n");
      ...
      printf(CYAN "                                                                  PROGRAM MENU:    \n                                                                                     \n");
      printf("                                                        Enter 1 to search function.      \n                                                        Enter 2 to exit.             \n                                                        Enter 3 to print the tree of functions.   \n" RESET);
